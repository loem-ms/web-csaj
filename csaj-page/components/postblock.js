        ...
        <div className="relative">
            ...
            <div className="relative mt-5">
                ...
                <a href={`/posts/${post.id}`} className="block mb-3 hover:underline">
                    <h2 className="text-xl font-bold leading-5 text-black transition-colors duration-200 hover:text-deep-purple-accent-700">
                        {post.title}
                    </h2>
                </a>
                ...
                <a href={`/posts/${post.id}`} className="font-medium underline">Read More</a>
            </div>
        </div>
    );
}