...
export default function Footer() {
    return (
        <section className="text-gray-800 bg-gray-100 body-font text-lg">
            <div className="flex flex-row items-center px-8 py-8 max-w-8xl justify-between space-x-36">
                <div className="flex-none">
                    <p className="font-mono">Copyright © {YEAR} Cambodian Students' Association in Japan (CSAJ)
                    </p>
                </div>

                <div className="flex-auto text-right">
                    <p className="font-mono">csaj.info@gmail.com</p>
                </div>
