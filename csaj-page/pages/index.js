  ...
  return (
    ...
    <section className="">
        <div className="flex max-w-7xl lg:flex-row space-x-24 relative mx-auto py-16 lg:py-16 ">
          <div className="lg:w-1/2 w-full lg:max-w-none max-w-2xl relative flex items-start justify-center flex-col">  
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-mono mb-8 relative text-blue-600">
        ...
        <div className="px-10 mx-auto max-w-7xl">
            <div className="text-center">
                <h2 className="relative text-blue-600 inline-block px-5 py-2 mb-5 text-5xl font-bold font-extrabold bg-white border-2 border-black">
                    ...
                    <span className="relative font-mono lg:text-5xl"><a href="/news">Our Activities</a></span>
                </h2>
            </div>
            ...
            <p className="text-2xl font-mono text-gray-800 mb-7 text-right py-4"><a href="/news">See more</a></p>
        </div>
    </section>
    </>
    ...
    <section className="w-full py-8 bg-white">
          <div className="container px-8 mx-auto sm:px-12 lg:px-20">
              <h1 className="mb-3 text-3xl font-bold leading-tight text-center text-gray-900 md:text-5xl font-mono">Our Partners</h1>
