        ...
        <section className="w-full px-8 text-gray-700 bg-white">
            <div className="flex flex-col flex-wrap items-center justify-between py-6 mx-auto md:flex-row max-w-7xl">
                ...
                <div className="inline-flex items-center lg:justify-end xl:ml-5">
                    <nav className="flex flex-wrap items-center space-x-2 text-2xl font-sans font-medium tracking-tighter uppercase sm:space-x-16">
                    ...
                    <a href="#" className="inline-flex tracking-tighter uppercase text-xl items-center sm:mt-0 mt-5 sm:ml-8 justify-center px-5 py-2.5  text-white bg-gray-800 border border-transparent rounded-md shadow-sm hover:bg-gray-900  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">Join Us</a>
                </div>
